var base_url = window.location.origin + '/shareair';
var green_light_css_url = base_url + '/css/skins/green-light.css';
var green_light_logo_url = base_url + '/img/logos/green-light-logo.png';
/*var shareair_logo_url = base_url + '/public/img/logo.png';*/
...
$(function () {
    ...
    $(window).load(function () {
        ...
        $('link[id="style_sheet"]').attr('href', green_light_css_url);
        //$('.logo img').attr('src', green_light_logo_url);
       /* $('link[id="style_sheet"]').attr('href', shareair_logo_url);
        $('.logo img').attr('src', shareair_logo_url);*/
    });
...
// Banner slider
 ...
 /*   $(function () {
    ...
    $('.color-plate').on('click', function () {
        ...
        $('link[id="style_sheet"]').attr('href', base_url + '/css/skins/' + name + '.css');
        if (name == 'default') {
            $('.logo img').attr('src', base_url + '/img/logos/logo.png');
        }
        else {
            $('.logo img').attr('src', base_url + '/img/logos/' + name + '-logo.png');
        }
    });
